...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 40.0, 219.0, 28.0 ],
					"text" : "Spectral Slope",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 10.0, 219.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 73.0, 310.769226000000003, 225.0, 22.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 33.0, 612.03606653213501, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 299.57213306427002, 80.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 609.0, 333.57213306427002, 89.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 561.0, 362.53606653213501, 67.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 561.0, 408.53606653213501, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 693.03606653213501, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 270.0, 480.53606653213501, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 387.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 270.0, 447.53606653213501, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 270.0, 420.53606653213501, 36.0, 22.0 ],
					"text" : "> 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 270.0, 627.03606653213501, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"patching_rect" : [ 270.0, 599.03606653213501, 77.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 509.03606653213501, 84.0, 84.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 420.0, 437.0, 53.0, 22.0 ],
					"text" : "slide 5 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 435.5, 473.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 469.5, 61.0, 22.0 ],
					"text" : "normalize"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 420.0, 553.5, 300.0, 100.0 ],
					"setstyle" : 3,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 57.799999999999997, 146.0, 56.0, 22.0 ],
									"text" : "trough 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 223.0, 94.0, 22.0 ],
									"text" : "scale 0. 1. -1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "float", "int", "int" ],
									"patching_rect" : [ 117.799999999999997, 146.0, 48.0, 22.0 ],
									"text" : "peak 0."
								}
...
,
					"patching_rect" : [ 420.0, 506.53606653213501, 99.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 420.0, 403.96393346786499, 81.0, 22.0 ],
					"text" : "snapshot~ 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 73.0, 494.0, 74.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.0, 463.0, 39.0, 22.0 ],
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 73.0, 431.0, 74.0, 22.0 ],
					"text" : "zl stream 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 73.0, 351.0, 154.0, 22.0 ],
					"text" : "sico.fft.spectral.slope 512 4"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 82.5, 342.902646266067507, 42.5, 342.902646266067507 ],
					"order" : 1,
					"source" : [ "obj-69", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "sico.fft.spectral.slope.maxpat",
...
, 			{
				"name" : "sico.spectral.slope.maxpat",
				"bootpath" : "~/Documents/SICO/sico.descriptors/abs",
				"patcherrelativepath" : "../abs",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "sico.spectral.slope.gendsp",
